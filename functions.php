...
function style_scripts() {
	wp_enqueue_style('main-stylesheet', get_stylesheet_directory_uri().'/styles/main.css');
}
 ...
 */
function js_scripts() {
	wp_enqueue_script( 'bundle-js', get_stylesheet_directory_uri().'/scripts/bundle.js');
}
